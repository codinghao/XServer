...
#define MAKE_PARAM2_2(T1, T2)  MAKE_PARAM2_1(T1, T2), T2##2 T2##2
#define MAKE_PARAM2_3(T1, T2)  MAKE_PARAM2_2(T1, T2), T3##2 T3##2
#define MAKE_PARAM2_4(T1, T2)  MAKE_PARAM2_3(T1, T2), T4##2 T4##2
#define MAKE_PARAM2_5(T1, T2)  MAKE_PARAM2_4(T1, T2), T5##2 T5##2
